...
. ├── models/ # Contains the bronze and silver transformation in Glue. ├── files/ # Contains a sample file uploaded in S3 to trigger the Lambda. ├── assets/ # Images. └── lambda.py # Lambda code to start the workflow.
